...
@jira_measure("locust_app_property_action")
@run_as_specific_user(username=JIRA_SETTINGS.admin_login, password=JIRA_SETTINGS.admin_password)
...
@jira_measure("locust_app_license_action")
